...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GigApp.Domain.Entities.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GigApp.Domain.Entities.FreelancerLicense", b =>
                {
                    ...
                    b.ToTable("FreelancerLicenses", (string)null);
                });

            modelBuilder.Entity("GigApp.Domain.Entities.Hiring", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("HiredManagerId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("HiredManagerId");

                    b.HasIndex("JobId");

                    b.ToTable("Hirings", (string)null);
                });
            ...
            modelBuilder.Entity("GigApp.Domain.Entities.Job", b =>
                {
                    ...
                    b.Property<string>("LicenseRequirments")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GigApp.Domain.Entities.JobQuestionnaire", b =>
                {
                    ...
                    b.ToTable("JobQuestionnaires", (string)null);
                });
            ...
            modelBuilder.Entity("GigApp.Domain.Entities.JobQuestionnaireAnswer", b =>
                {
                    ...
                    b.ToTable("JobQuestionnaireAnswers", (string)null);
                });
            ...
            modelBuilder.Entity("GigApp.Domain.Entities.Hiring", b =>
                {
                    b.HasOne("GigApp.Domain.Entities.User", "Freelancer")
                        .WithMany()
                        .HasForeignKey("FreelancerId");

                    b.HasOne("GigApp.Domain.Entities.User", "HiredManager")
                        .WithMany()
                        .HasForeignKey("HiredManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
