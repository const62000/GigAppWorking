...
GO
/****** Object:  Table [dbo].[Clients]    Script Date: 1/24/2025 6:45:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ClientLocations]    Script Date: 1/24/2025 6:45:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[ClientManagers]    Script Date: 1/24/2025 6:45:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ALTER TABLE [dbo].[Ratings] WITH CHECK ADD CONSTRAINT [FK_Ratings_Clients] FOREIGN KEY([FacilityId])
...
ALTER TABLE [dbo].[ClientManagers] WITH NOCHECK ADD FOREIGN KEY([ClientId])
REFERENCES [dbo].[Clients] ([Id])
GO

ALTER TABLE [dbo].[ClientManagers] WITH NOCHECK ADD FOREIGN KEY([UserId])
REFERENCES [dbo].[Users] ([Id])
GO

ALTER TABLE [dbo].[Users] WITH NOCHECK ADD CONSTRAINT [FK_Users_Address] FOREIGN KEY([AddressId])
REFERENCES [dbo].[Addresses] ([Id])
GO

--ALTER TABLE [dbo].[Addresses] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
--GO
--ALTER TABLE [dbo].[Addresses] ADD  DEFAULT (getutcdate()) FOR [UpdatedAt]
--GO
--ALTER TABLE [dbo].[Clients] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
--GO
--ALTER TABLE [dbo].[Clients] ADD  DEFAULT (getutcdate()) FOR [UpdatedAt]
--GO
--ALTER TABLE [dbo].[ClientLocations] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
--GO
--ALTER TABLE [dbo].[ClientLocations] ADD  DEFAULT (getutcdate()) FOR [UpdatedAt]
--GO
--ALTER TABLE [dbo].[Contracts] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
--GO
ALTER TABLE [dbo].[FacilityManagers] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
ALTER TABLE [dbo].[FreelancerLicenses] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
ALTER TABLE [dbo].[Freelancers] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
--ALTER TABLE [dbo].[Invoices] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
ALTER TABLE [dbo].[JobApplications] ADD  DEFAULT ((0)) FOR [Viewed]
GO
--ALTER TABLE [dbo].[JobApplications] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
ALTER TABLE [dbo].[JobQuestionnaireAnswers] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
ALTER TABLE [dbo].[JobQuestionnaires] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
--ALTER TABLE [dbo].[Jobs] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
--ALTER TABLE [dbo].[Jobs] ADD  DEFAULT (getutcdate()) FOR [UpdatedAt]
GO
ALTER TABLE [dbo].[PaymentMethods] ADD  DEFAULT ((0)) FOR [is_default]
GO
ALTER TABLE [dbo].[PaymentMethods] ADD  DEFAULT ('active') FOR [status]
GO
--ALTER TABLE [dbo].[PaymentMethods] ADD  DEFAULT (getutcdate()) FOR [created_at]
GO
--ALTER TABLE [dbo].[PaymentMethods] ADD  DEFAULT (getutcdate()) FOR [updated_at]
GO
...
GO
--ALTER TABLE [dbo].[Vendors] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
--ALTER TABLE [dbo].[VendorsRegistrants] ADD  DEFAULT (getutcdate()) FOR [CreatedAt]
GO
ALTER TABLE [dbo].[Addresses]
ADD [ClientId] [bigint] NULL;
GO
ALTER TABLE [dbo].[Addresses]  WITH NOCHECK ADD  CONSTRAINT [FK_Addresses_Client] FOREIGN KEY([ClientId])
REFERENCES [dbo].[Clients] ([Id])
ON DELETE CASCADE
Go
ALTER TABLE [dbo].[Addresses] NOCHECK CONSTRAINT [FK_Addresses_Client]
GO
ALTER TABLE [dbo].[Addresses]
...
GO
ALTER TABLE [dbo].[Clients]  WITH NOCHECK ADD  CONSTRAINT [FK_Clients_AdminUser] FOREIGN KEY([AdminUserId])
REFERENCES [dbo].[Users] ([Id])
GO
ALTER TABLE [dbo].[Clients] NOCHECK CONSTRAINT [FK_Clients_AdminUser]
GO
ALTER TABLE [dbo].[ClientLocations]  WITH NOCHECK ADD CONSTRAINT [FK_ClientLocations_Address] FOREIGN KEY([AddressId])
REFERENCES [dbo].[Addresses] ([Id])
GO
ALTER TABLE [dbo].[ClientLocations] NOCHECK CONSTRAINT [FK_ClientLocations_Address]
GO
ALTER TABLE [dbo].[ClientLocations]  WITH NOCHECK ADD  CONSTRAINT [FK_ClientLocations_Client] FOREIGN KEY([ClientId])
REFERENCES [dbo].[Clients] ([Id])
GO
ALTER TABLE [dbo].[ClientLocations] NOCHECK CONSTRAINT [FK_ClientLocations_Client]
GO
ALTER TABLE [dbo].[ClientLocations]  WITH NOCHECK ADD  CONSTRAINT [FK_ClientLocations_CreatedByUser] FOREIGN KEY([CreatedByUserId])
REFERENCES [dbo].[Users] ([Id])
GO
ALTER TABLE [dbo].[ClientLocations] NOCHECK CONSTRAINT [FK_ClientLocations_CreatedByUser]
GO
...
GO
ALTER TABLE [dbo].[Jobs]  WITH NOCHECK ADD  CONSTRAINT [FK_Jobs_Client] FOREIGN KEY([ClientId])
REFERENCES [dbo].[Clients] ([Id])
GO
ALTER TABLE [dbo].[Jobs] NOCHECK CONSTRAINT [FK_Jobs_Client]
GO
...
GO
ALTER TABLE [dbo].[PaymentMethods]  WITH NOCHECK ADD  CONSTRAINT [FK__PaymentMe__client__5772F790] FOREIGN KEY([client_id])
REFERENCES [dbo].[Clients] ([Id])
ON DELETE SET NULL
GO
ALTER TABLE [dbo].[PaymentMethods] NOCHECK CONSTRAINT [FK__PaymentMe__client__5772F790]
GO
