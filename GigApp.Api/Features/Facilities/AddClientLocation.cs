...
using static GigApp.Application.CQRS.Implementations.Facilities.Commands.AddClientLoaction;

namespace GigApp.Api.Features.Facilities

{
    public class AddClientLocation : ICarterModule
    {
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            app.MapPost(EndPoints.Client_Location, async (ClientLocationRequest request, ISender sender, HttpContext ctx, IMapper _mapper) =>
            {
